...
const plans = [
  {
    ...
    price: "$0",
    period: "forever",
    description: "Try it on your first tracks.",
    features: ["3 tracks / month", "Technical mode", "Basic frequency analysis", "48h cooldown between uploads"],
    cta: "Start free",
    featured: false,
  },
  {
    ...
    price: "$19",
    period: "/ month",
    description: "For producers who release regularly.",
  ...
  },
  {
    ...
    price: "$49",
    period: "/ track",
    description: "AI analysis plus a mixing engineer's notes.",
    features: ["Everything in Pro", "Engineer review", "Video walkthrough", "Follow-up session", "Revision notes"],
    cta: "Book a review",
    featured: false,
  },
];
